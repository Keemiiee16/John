...
function johnNotificationPrivacy(type){
  return JOHN_PRIVATE_NOTIFICATION_TYPES.has(type) ? "private" : "public";
}
    ...
    if (i.isButton()) {
      ...
      if (id === "vantage_buy_now") {
        ...
        await sendJohnNotification({
          ...
          payload:{
            embeds:[new EmbedBuilder()
              .setTitle("📦 Vantage Order Placed")
              .setDescription(`**${c.name}** placed a Vantage order for **${action.itemName}**.\n**Total:** ${nova(r?.total_voro_out||total)}\n**Kinetix:** Confirmed`)]
          }
        });
      ...
      if (id === "vantage_checkout") {
        ...
        await sendJohnNotification({
          ...
          payload:{
            embeds:[new EmbedBuilder()
              .setTitle("📦 Vantage Order Placed")
              .setDescription(`**${c.name}** placed a Vantage order.\n${vantageCartLines(cart)}\n\n**Total:** ${nova(r?.total_voro_out||total)}\n**Kinetix:** Confirmed`)]
          }
        });
