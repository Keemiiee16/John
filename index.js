  ...
  try {
    ...
    if (i.isStringSelectMenu()) {
      ...
      if (id === "shop_gift_character") {
        ...
        return respond(i,{content:`🎁 **${buyer.name}** bought **${r.item_name_out}** for **${recipient.name}** for **${nova(r.price_voro_out)}**.`});
      }
      ...
      if (id === "inventory_give_character") {
        ...
        return respond(i,{
          content:`🎁 **${giver.name}** gave **${r.item_name_out}** to **${recipient.name}**.`
        });
      }
