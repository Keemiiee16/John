  ...
  try {
    ...
    if (i.isButton()) {
      ...
      if (id === "shop_buy") {
        ...
        return respond(i,{
          ...
          components:[buttonRow([
            {id:`shop_buy_confirm:${c.id}:${businessId}:${itemId}`,label:`Confirm — ${nova(item.price_voro)}`,style:ButtonStyle.Success},
            {id:`shop_page:${c.id}:${businessId}:0`,label:"Cancel / Back"}
          ])]
        });
      }
      ...
      if (id === "shop_buy_confirm") {
        ...
        return respond(i,{
          ...
          components:[buttonRow([
            {id:`shop_page:${c.id}:${businessId}:0`,label:"Keep Shopping",style:ButtonStyle.Primary}
          ])]
        });
      }
      ...
      if (id === "shop_gift") {
        ...
        return respond(i,{
          ...
          components:[userSelectRow(`shop_gift_user:${c.id}:${businessId}:${itemId}`,"Choose recipient")]
        });
      }
    ...
    if (i.isUserSelectMenu()) {
      ...
      if (i.customId.startsWith("shop_gift_user:")) {
        const parts = i.customId.split(":");
        const buyerCharacterId = parts[1];
        const businessId = parts[2];
        const itemId = parts[3];
        await ensureOwnedCharacter(buyerCharacterId,i.user.id);
        ...
        return respond(i,{
          ...
          components:[selectRow(`shop_gift_character:${buyerCharacterId}:${businessId}:${itemId}:${targetUserId}`,"Choose recipient character",chars.map(c=>({label:c.name,value:c.id})))]
        });
      }
    ...
    if (i.isStringSelectMenu()) {
      ...
      if (id === "shop_gift_character") {
        const buyer = await ensureOwnedCharacter(arg1,i.user.id);
        const parts = i.customId.split(":");
        const businessId = parts[2];
        const itemId = parts[3];
      ...
      if (id === "shop_item") {
        ...
        return respond(i,{
          ...
          components:[buttonRow([
            {id:`shop_buy:${c.id}:${businessId}:${item.id}`,label:"Buy Now",style:ButtonStyle.Success},
            {id:`shop_gift:${c.id}:${businessId}:${item.id}`,label:"Gift"},
            {id:`shop_page:${c.id}:${businessId}:${Number(i.customId.split(":")[3] || 0)}`,label:"Back to Menu"}
          ])]
        });
      }
