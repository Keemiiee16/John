  ...
  try {
    ...
    if (i.isStringSelectMenu()) {
      ...
      if (id === "business_manage_action") {
        ...
        if (value === "add") {
          return respond(i,{content:"Add more menu/catalog items:",components:[
            buttonRow([{id:`business_bulk_add:${businessId}`,label:"Add 5 Items",style:ButtonStyle.Success}])
          ]});
        }
