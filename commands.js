...
export const commands = [
  ...
  new SlashCommandBuilder()
    .setName("inventory")
    .setDescription("View your active character's owned items and gifts"),
  ...
  new SlashCommandBuilder()
    .setName("clubs")
    .setDescription("Browse, join, create, and manage clubs and groups"),
  ...
  new SlashCommandBuilder()
    .setName("action")
    .setDescription("Work, use subscriptions, or do club activities"),
